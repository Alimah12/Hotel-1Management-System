		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SPARK<p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SPARK</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SPARK</h3> 
						   <p class="about-para-w3ls">We are providing you the best services at the best prices.Try us once for unforgetable experience.</p>
...
<!--section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SPARK.COM</a></p>
...
<! /contact -->
			<div class="copy">
		        <!--<p>© 2017 SPARK . All Rights Reserved | Design by <a href="index.php">SPARK</a> </p>-->
		    </div>
<!--/footer -->
<!-- js -->
